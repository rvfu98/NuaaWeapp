...
var setCourse = function(that, flag){
    var semester_data_name = that.data.SEMESTERS[that.data.semester].name;
    ...
    if (semester_data.maxDay &&  (!flag)){
        ...
        wx.request({
            url: 'https://proj.rvfu98.com/nuaaweapp/zlxxapi/getCourse.php',
            method: "POST",
            header: {
                'content-type': 'application/x-www-form-urlencoded'
            },
            data:{
                studentid: wx.getStorageSync('info').number,
                semester: semester_data_name
            },
